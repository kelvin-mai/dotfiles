...
let g:dracula#palette.bglighter = ['#424450', 237]
let g:dracula#palette.bglight   = ['#343746', 236]
let g:dracula#palette.bg        = ['#282A36', 235]
let g:dracula#palette.bgdark    = ['#21222C', 234]
let g:dracula#palette.bgdarker  = ['#191A21', 233]
