...
" Author: Kelvin Mai
" License: MIT License
" Last Change: 2019/07/24 13:58:01.
" =============================================================================

" Common colors
let s:dracula = [ '#BD93F9', 141 ]
let s:fg     = [ '#abb2bf', 145 ]
let s:blue   = [ '#8BE9FD', 117 ]
let s:green  = [ '#50FA7B', 84 ]
let s:purple = [ '#FF79C6', 212 ]
let s:red1   = [ '#FF5555', 203 ]
...
if lightline#colorscheme#background() ==# 'light'
  ...
  let s:gray2  = [ '#282A36', 236 ]
  let s:gray3  = [ '#3e4452', 240 ]

  let s:p.normal.left     = [ [ s:bg, s:dracula, 'bold' ], [ s:fg, s:gray3 ] ]
...
" Common
let s:p.normal.right   = [ [ s:bg, s:dracula, 'bold' ], [ s:bg, s:dracula, 'bold' ] ]
